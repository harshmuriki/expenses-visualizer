...
export interface MyCustomNodeProps {
  ...
  onNodeDrop?: (nodeId: string) => void; // Add drop handler for drag and drop
  isDragging?: boolean; // Whether any node is being dragged
  isDragNode?: boolean; // Whether this node is being dragged
  allNodes: SankeyNode[];
  fixViz: boolean;
  colorThreshold?: number; // Threshold for color changes
